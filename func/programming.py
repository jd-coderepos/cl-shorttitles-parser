...
def computer_science(line):
	...
	if len(connector_indexes) == 0:
		...
		elif is_research_problem(line) or is_method(line) or is_tool(line) or 'programming language' in line:
		...
		if 'programming' in subpart_0.lower():
